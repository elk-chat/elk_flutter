...
class NewGroupChatCreatePage extends StatefulWidget {
  final String title;
  final List members;
...
class _NewGroupChatState extends State<NewGroupChatCreatePage> {
  ...
  handleCreateChat() async {
    try {
      var res = await $CH.chatApi.create(text, avatarFileID);
      ...
      $CH.chatApi.addMembers(widget.members, res.chat.chatID);
