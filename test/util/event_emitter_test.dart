...
import 'package:elk_chat/protocol/util/event_emitter.dart' show EventEmitter;
...
void main() {
  ...
  group('cancel', () {
    test(
        'Listen the event and .on should return a Function to cancel listening',
        () {
      expect(emitter.events, hasLength(0));
      int firedTimes = 0;
    ...
    test('cancel a listening in multiple listnings', () {
      ...
      emitter.on('2', (dynamic data) {});
      emitter.on('3', (dynamic data) {});
